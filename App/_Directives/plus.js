(function () {
    ...
    angular.module("datacollection.directives").directive("ownerPn", ['$q',Directive]);
...
(function () {
        ...
        return {
            ...
            link:function ($scope, element, attrs, ngModel) {
                ...
                $scope.verifyDuplicate = function(that, rec, index){
                    if($scope.unics.hasOwnProperty(rec.phone) && $scope.unics[rec.phone]!==index ){
                        rec.phone = "";
                    }else{
    ...
    angular.module("datacollection.directives").directive("repetitivePhones", ['$q',Directive]);
