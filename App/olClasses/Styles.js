var Styles = (function () {
  ...
  Styles.createTextStyle = function (feature) {
    var text = feature.get("BLOCK_ID")
      ? "BLOCK_ID: " + feature.getProperties()["BLOCK_ID"].toString()
      : "GROUP_ID: " + feature.getProperties()["GROUP_ID"].toString();
    var align = "center";
    var baseline = "middle";
...
Styles.signsStykeFunction = function (feature) {
  ...
  var styles = [Styles.POIFeatureStyle];
