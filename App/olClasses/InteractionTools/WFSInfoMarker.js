...
var WFSInfoMarker = (function () {
    ...
    WFSInfoMarker.prototype.initMapInteraction = function () {
        var mapOnClickActionForSavingPositionCoordinates = this.getMapOnClickActionForSavingPositionCoordinates();
        this.map.on('click', mapOnClickActionForSavingPositionCoordinates);
    };
    WFSInfoMarker.prototype.getMapOnClickActionForSavingPositionCoordinates = function () {
        var self = this;
        return function (evt) {
    ...
    WFSInfoMarker.prototype.showInfo = function (feature, coordinates) {
        ...
        if (infoContent == null)
            ...
            PopUpWindowCaller.showPopUp(coordinates, infoContent);
    };
