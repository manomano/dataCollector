...
NGCACHEServerInfo.NGCACHE_URL_TEMPLATE =
  currentConnections.NGCACHE_URL_TEMPLATE;
...
NGCACHEServerInfo.BUILDING_ENTRANCE =
  NGCACHEServerInfo.NAME + ":BUILDING_ENTRANCE";
NGCACHEServerInfo.EXISTING_PARCEL = NGCACHEServerInfo.NAME + ":EXISTING_PARCEL";
NGCACHEServerInfo.EXISTING_OBJECTS =
  NGCACHEServerInfo.NAME + ":EXISTING_OBJECTS";
...
var NGCACHEDataGatheringLayers = (function () {
  ...
  NGCACHEDataGatheringLayers.prototype.trafficSignLayer = function () {
    var Layer = LayerUtils.generateNGCACHETileLayer(
      NGCACHEServerInfo.TRAFFIC_SIGN
    );
  ...
  NGCACHEDataGatheringLayers.prototype.assignmentLayer = function () {
    var Layer = LayerUtils.generateNGCACHETileLayer(
      NGCACHEServerInfo.AREA_ASSIGNMENT
    );
  ...
  NGCACHEDataGatheringLayers.prototype.RoadAssignmentLayer = function () {
    var Layer = LayerUtils.generateNGCACHETileLayer(
      NGCACHEServerInfo.ROAD_ASSIGNMENT
    );
  ...
  NGCACHEDataGatheringLayers.prototype.parcelEntranceLayer = function () {
    var Layer = LayerUtils.generateNGCACHETileLayer(
      NGCACHEServerInfo.PARCEL_ENTRANCE
    );
  ...
  NGCACHEDataGatheringLayers.prototype.existingParcelLayer = function () {
    var Layer = LayerUtils.generateNGCACHETileLayer(
      NGCACHEServerInfo.EXISTING_PARCEL
    );
