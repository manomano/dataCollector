...
var WMSDataGatheringLayers = (function () {
  ...
  WMSDataGatheringLayers.prototype.poiLayer = function () {
    var params = {
      LAYERS: currentConnections.geoServerWorkSpaceName + ":POI",
      TILED: true,
    };
    params["env"] =
      LayerUtils.getPlaceIdEnvVariable(utils.placeId()) +
      LayerUtils.getUserIdEnvVariable(utils.getUserId());
  ...
  WMSDataGatheringLayers.prototype.trafficSignLayer = function () {
    var params = {
      LAYERS: currentConnections.geoServerWorkSpaceName + ":TRAFFIC_SIGN",
      TILED: true,
    };
    params["env"] =
      LayerUtils.getPlaceIdEnvVariable(utils.placeId()) +
  ...
  WMSDataGatheringLayers.prototype.busStopLayer = function () {
    var params = {
      LAYERS: currentConnections.geoServerWorkSpaceName + ":BUS_STOP",
      TILED: true,
    };
    params["env"] =
      LayerUtils.getPlaceIdEnvVariable(utils.placeId()) +
  ...
  WMSDataGatheringLayers.prototype.assignmentLayer = function () {
    var params = {
      LAYERS: currentConnections.geoServerWorkSpaceName + ":ASSIGNMENT",
      TILED: true,
    };
    params["env"] =
      LayerUtils.getPlaceIdEnvVariable(utils.placeId()) +
  ...
  WMSDataGatheringLayers.prototype.RoadAssignmentLayer = function () {
    var params = {
      LAYERS: currentConnections.geoServerWorkSpaceName + ":ROAD_ASSIGNMENT",
      TILED: true,
    };
    params["env"] =
      LayerUtils.getPlaceIdEnvVariable(utils.placeId()) +
  ...
  WMSDataGatheringLayers.prototype.parcelEntranceLayer = function () {
    var params = {
      LAYERS: NGCACHEServerInfo.NAME + ":PARCEL_ENTRANCE",
      TILED: true,
    };
    params["env"] =
      LayerUtils.getPlaceIdEnvVariable(utils.placeId()) +
  ...
  WMSDataGatheringLayers.prototype.buildingEntranceLayer = function () {
    var params = {
      LAYERS: NGCACHEServerInfo.NAME + ":BUILDING_ENTRANCE",
      TILED: true,
    };
    params["env"] =
      LayerUtils.getPlaceIdEnvVariable(utils.placeId()) +
  ...
  WMSDataGatheringLayers.prototype.existingParcelLayer = function () {
    var params = {
      LAYERS: NGCACHEServerInfo.NAME + ":EXISTING_PARCEL",
      TILED: true,
    };
    params["env"] =
      LayerUtils.getPlaceIdEnvVariable(utils.placeId()) +
  ...
  WMSDataGatheringLayers.prototype.existingBuildingLayer = function () {
    var params = {
      LAYERS: NGCACHEServerInfo.NAME + ":EXISTING_BUILDING",
      TILED: true,
    };
    params["env"] =
      LayerUtils.getPlaceIdEnvVariable(utils.placeId()) +
  ...
  WMSDataGatheringLayers.prototype.existingObjectLayer = function () {
    var params = {
      LAYERS: NGCACHEServerInfo.NAME + ":EXISTING_OBJECTS",
      TILED: true,
    };
    params["env"] =
      LayerUtils.getPlaceIdEnvVariable(utils.placeId()) +
