(function () {
  var ParcelService = function ($auth, http, $location, StorageService) {
    ...
    this.getAdminPath = function () {
      return StorageService.getObject("Authorization")
        ? StorageService.getObject("Authorization")["role"] == "ROLE_ADMIN"
          ? "admin/"
          : ""
        : "";
    };
    ...
    this.PARCEL_CREATE = {
      ...
      parcelEntranceGeometry:
        url + this.getAdminPath() + "pebe/parcels/x/parcelEntrances",
      parcelEntranceInfo:
        url + this.getAdminPath() + "pebe/parcelEntrances/x/metadata",
      ...
      buildingEntranceGeometry:
        url + this.getAdminPath() + "pebe/buildings/x/buildingEntrances",
      buildingEntranceInfo:
        url + this.getAdminPath() + "pebe/buildingEntrances/x/metadata",
    };
    ...
    this.PARCEL_EDIT = {
      ...
      parcelInfo: url + this.getAdminPath() + "pebe/parcels/x/metadata",
      parcelEntranceGeometry:
        url + this.getAdminPath() + "pebe/parcelEntrances/x/geometry",
      parcelEntranceInfo:
        url + this.getAdminPath() + "pebe/parcelEntrances/x/metadata",
      buildingGeometry: url + this.getAdminPath() + "pebe/buildings/x/geometry",
      buildingInfo: url + this.getAdminPath() + "pebe/buildings/x/metadata",
      buildingEntranceGeometry:
        url + this.getAdminPath() + "pebe/buildingEntrances/x/geometry",
      buildingEntranceInfo:
        url + this.getAdminPath() + "pebe/buildingEntrances/x/metadata",
    };
    ...
    this.delete_parcelEntrance = function (id) {
      return http.delete(
        url + this.getAdminPath() + "pebe/parcelEntrances/" + id
      );
    };

    this.delete_buildingEntrance = function (id) {
      return http.delete(
        url + this.getAdminPath() + "pebe/buildingEntrances/" + id
      );
    };
