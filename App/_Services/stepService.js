(function () {
    ...
    var FormService = function ($window, $mdDialog,http,StorageService) {
        ...
        this.allowDataEntrance = function (title, conf, metadata, callback, existingParcelProperties) {
        ...
        this.allowDataEntranceHierarchial = function (title, stepName, metadata, callback, existingParcelProperties) {
        ...
        this.showData = function (title, stepName, metadata, actualChildElementsNum, additional_info) {
...
(function () {
    ...
    angular.module("datacollection.services").service("assignmentService", assignmentService);
})();

(function () {
    var roadAssignmentService = function ($auth, http, $location,StorageService) {
        ...
        this.getInfo = function (id, serviceName) {
            ...
            return http.get(url+ this.getAdminPath() + serviceName+"/"+id+"/info");
        }
    }


    roadAssignmentService.$inject = ["$auth", "$http", "$location","StorageService"];
    angular.module("datacollection.services").service("roadAssignmentService", roadAssignmentService);
})();
