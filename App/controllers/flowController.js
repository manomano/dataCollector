(function () {
  var flowControllerService = function (
    $rootScope,
    $mdToast,
    ...
    this.init = function (map) {
      ...
      initialControllerService.subscriber.addCallback(
        initialControllerService,
        this.next
      );
    };
    ...
    this.next = function (parameters) {
      ...
      if (stepControllerIndex == 0) {
        ...
        parcelControllerService.subscriber.addCallback(
          parcelControllerService,
          f
        );
        me.showToast();
        ...
        parcelEntranceControllerService.subscriber.addCallback(
          parcelEntranceControllerService,
          f
        );
      } else if (stepControllerIndex == 3) {
        buildingControllerService.init({
          parcel_id: $rootScope.parcel_id,
          allowed_count: me.buildings_count,
        });
        buildingControllerService.turnOn();
        buildingControllerService.subscriber.addCallback(
          buildingControllerService,
          f
        );
      }
  ...
  angular
    ...
    .service("flowControllerService", flowControllerService);
})();
